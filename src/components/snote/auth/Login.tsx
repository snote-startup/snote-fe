...
const trustMetrics = [
    ...
    { label: 'Meeting memory', value: 'AI' },
    { label: 'Workspace security', value: 'SSO' },
];
    ...
    return (
        <main className="bg-background text-foreground relative isolate flex min-h-screen overflow-hidden px-4 py-6 sm:px-6 lg:px-8">
            <motion.div
                ...
                style={{
                    background:
                        'radial-gradient(circle at 18% 20%, rgb(73 10 173 / 0.42), transparent 28%), radial-gradient(circle at 78% 12%, rgb(37 99 235 / 0.32), transparent 30%), radial-gradient(circle at 62% 76%, rgb(16 185 129 / 0.18), transparent 34%), linear-gradient(135deg, rgb(248 250 252), rgb(247 246 255) 45%, rgb(226 232 240))',
                ...
                <section className="hidden lg:block">
                    ...
                    >
                        ...
                        <h1 className="text-foreground max-w-3xl text-5xl leading-[1.02] font-semibold tracking-normal xl:text-6xl">
                            Sign in to a calmer, faster meeting command center.
                        </h1>
                        <p className="text-muted-foreground mt-6 max-w-xl text-lg leading-8">
                            Capture speech, translate speaker turns, and turn
                            the review into finished decisions without leaving
                            the room.
                        </p>
                    </motion.div>
                    ...
                    <div className="rounded-[22px] border border-white/40 bg-white/60 p-6 shadow-2xl shadow-[#490aad]/10 backdrop-blur-2xl sm:p-8 dark:border-white/10 dark:bg-black/20">
                        ...
                        <div className="mt-10">
                            ...
                            <p className="text-muted-foreground mt-3 text-sm leading-6">
                                Sign in with your SNOTE account to continue to{' '}
