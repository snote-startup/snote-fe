...
- Verified the core behavior: **Audio recording over WebSocket** (streaming `.webm` bytes to backend, getting `audio_url` upon socket close). This is explicitly *not* realtime translation.
